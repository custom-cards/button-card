function t(t, e, i, n) {
...
}const P = t => t && (C ? { capture: t.capture, passive: t.passive, once: t.once } : t.capture);const N = new class {
  ...
  let e = M.get(t.type);void 0 === e && (e = { stringsArray: new WeakMap(), keyString: new Map() }, M.set(t.type, e));let i = e.stringsArray.get(t.strings);if (void 0 !== i) return i;const n = t.strings.join(l);return void 0 === (i = e.keyString.get(n)) && (i = new u(t, t.getTemplateElement()), e.keyString.set(n, i)), e.stringsArray.set(t.strings, i), i;
      ...
      T = new WeakMap();(window.litHtmlVersions || (window.litHtmlVersions = [])).push("1.0.0");const $ = (t, ...e) => new b(t, e, "html", N),
      R = 133;function O(t, e) {
...
};const L = (t, e) => `${t}--${e}`;let j = !0;void 0 === window.ShadyCSS ? j = !1 : void 0 === window.ShadyCSS.prepareTemplateDom && (console.warn("Incompatible ShadyCSS version detected.Please update to at least @webcomponents/webcomponentsjs@2.0.2 and@webcomponents/shadycss@1.3.1."), j = !1);const F = t => e => {
  const i = L(e.type, t);let n = M.get(i);void 0 === n && (n = { stringsArray: new WeakMap(), keyString: new Map() }, M.set(i, n));let s = n.stringsArray.get(e.strings);if (void 0 !== s) return s;const r = e.strings.join(l);if (void 0 === (s = n.keyString.get(r))) {
    const i = e.getTemplateElement();j && window.ShadyCSS.prepareTemplateDom(i, t), s = new u(e, i), n.keyString.set(r, s);
  ...
  I.add(i);const n = t.querySelectorAll("style");if (0 === n.length) return void window.ShadyCSS.prepareTemplateStyles(e.element, i);const s = document.createElement("style");for (let t = 0; t < n.length; t++) {
    ...
    z.forEach(e => {
      const i = M.get(L(e, t));void 0 !== i && i.keyString.forEach(t => {
...
}Q.finalized = !0;const Z = (t, e) => "method" !== e.kind || !e.descriptor || "value" in e.descriptor ? { kind: "field", key: Symbol(), placement: "own", descriptor: {}, initializer() {
  ...
  const n = i.scopeName,
    ...
    let n = T.get(e);void 0 === n && (r(e, e.firstChild), T.set(e, n = new w(Object.assign({ templateFactory: E }, i))), n.appendInto(e)), n.setValue(t), n.commit();
  ...
  let r;switch (s && i.dbltap_action ? r = i.dbltap_action : n && i.hold_action ? r = i.hold_action : !n && i.tap_action && (r = i.tap_action), r || (r = { action: "toggle" }), r.action) {case "more-info":
      (i.entity || i.camera_image) && (jt(t, "hass-more-info", { entityId: i.entity ? i.entity : i.camera_image }), r.haptic && zt(t, r.haptic));break;case "navigate":
      r.navigation_path && (((t, e, i = !1) => {
        i ? history.replaceState(null, "", e) : history.pushState(null, "", e), jt(window, "location-changed", { replace: i });
      })(0, r.navigation_path), r.haptic && zt(t, r.haptic));break;case "url":
      r.url && window.open(r.url), r.haptic && zt(t, r.haptic);break;case "toggle":
      i.entity && (Ft(e, i.entity), r.haptic && zt(t, r.haptic));break;case "call-service":
      {
        if (!r.service) return;const [i, n] = r.service.split(".", 2);e.callService(i, n, r.service_data), r.haptic && zt(t, r.haptic);
      }}
},
      qt = "ontouchstart" in window || navigator.maxTouchPoints > 0 || navigator.msMaxTouchPoints > 0;customElements.define("long-press-button-card", class extends HTMLElement {
  constructor() {
...
`;let Wt = class extends at {
  static get styles() {
    ...
    let e = this.config.default_color;return t && (t.attributes.rgb_color ? (e = `rgb(${t.attributes.rgb_color.join(",")})`, t.attributes.brightness && (e = Lt(e, (t.attributes.brightness + 245) / 5))) : t.attributes.color_temp && t.attributes.min_mireds && t.attributes.max_mireds ? (e = function (t, e, i) {
    ...
    }(t.attributes.color_temp, t.attributes.min_mireds, t.attributes.max_mireds), t.attributes.brightness && (e = Lt(e, (t.attributes.brightness + 245) / 5))) : e = t.attributes.brightness ? Lt(this._getDefaultColorForState(t), (t.attributes.brightness + 245) / 5) : this._getDefaultColorForState(t)), e;
    ...
    const t = this.config.entity ? this.hass.states[this.config.entity] : void 0,
      ...
      <ha-card class="button-card-main ${this._isClickable(t) ? "" : "disabled"}" style=${ct(s)} @ha-click="${this._handleTap}" @ha-hold="${this._handleHold}" @ha-dblclick=${this._handleDblTap} .hasDblClick=${"none" !== this.config.dbltap_action.action} .repeat=${ut(this.config.hold_action.repeat)} .longpress="${Dt()}" .config="${this.config}">
        ${this._getLock(r)}
...
};t([et()], Wt.prototype, "hass", void 0), t([et()], Wt.prototype, "config", void 0), Wt = t([(t => e => "function" == typeof e ? ((t, e) => (window.customElements.define(t, e), e))(t, e) : ((t, e) => {
