  ...
  constructor(t, e, n) {
    ...
    for (; i(this._pendingValue);) {
      const t = this._pendingValue;this._pendingValue = a, t(this);
          ...
          s = null != t && (null == e || n);n && this.element.removeEventListener(this.eventName, this._boundHandleEvent, this._options), s && (this._options = P(t), this.element.addEventListener(this.eventName, this._boundHandleEvent, this._options)), this.value = t, this._pendingValue = a;
  }handleEvent(t) {
 ...
 */const N = new class {
  handleAttributeExpressions(t, e, n, i) {
    const s = e[0];return "." === s ? new x(t, e.slice(1), n).parts : "@" === s ? [new A(t, e.slice(1), i.eventContext)] : "?" === s ? [new S(t, e.slice(1), n)] : new _(t, e, n).parts;
 ...
 * http://polymer.github.io/PATENTS.txt
 */function E(t) {
  let e = M.get(t.type);void 0 === e && (e = { stringsArray: new WeakMap(), keyString: new Map() }, M.set(t.type, e));let n = e.stringsArray.get(t.strings);if (void 0 !== n) return n;const i = t.strings.join(l);return void 0 === (n = e.keyString.get(i)) && (n = new u(t, t.getTemplateElement()), e.keyString.set(i, n)), e.stringsArray.set(t.strings, n), n;
}const M = new Map(),
      T = new WeakMap();
/**
 * @license
 ...
 * http://polymer.github.io/PATENTS.txt
 */
(window.litHtmlVersions || (window.litHtmlVersions = [])).push("1.0.0");const $ = (t, ...e) => new b(t, e, "html", N),
      R = 133;
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 ...
 */function O(t, e) {
  const { element: { content: n }, parts: i } = t,
        s = document.createTreeWalker(n, R, null, !1);let r = H(i),
      a = i[r],
      o = -1,
      l = 0;const c = [];let h = null;for (; s.nextNode();) {
    o++;const t = s.currentNode;for (t.previousSibling === h && (h = null), e.has(t) && (c.push(t), null === h && (h = t)), null !== h && l++; void 0 !== a && a.index === o;) a.index = null !== h ? -1 : a.index - l, a = i[r = H(i, r)];
...
const j = (t, e) => `${t}--${e}`;let L = !0;void 0 === window.ShadyCSS ? L = !1 : void 0 === window.ShadyCSS.prepareTemplateDom && (console.warn("Incompatible ShadyCSS version detected.Please update to at least @webcomponents/webcomponentsjs@2.0.2 and@webcomponents/shadycss@1.3.1."), L = !1);const F = t => e => {
  const n = j(e.type, t);let i = M.get(n);void 0 === i && (i = { stringsArray: new WeakMap(), keyString: new Map() }, M.set(n, i));let s = i.stringsArray.get(e.strings);if (void 0 !== s) return s;const r = e.strings.join(l);if (void 0 === (s = i.keyString.get(r))) {
    const n = e.getTemplateElement();L && window.ShadyCSS.prepareTemplateDom(n, t), s = new u(e, n), i.keyString.set(r, s);
  }return i.stringsArray.set(e.strings, s), s;
},
      z = ["html", "svg"],
      I = new Set(),
      q = (t, e, n) => {
  I.add(n);const i = t.querySelectorAll("style");if (0 === i.length) return void window.ShadyCSS.prepareTemplateStyles(e.element, n);const s = document.createElement("style");for (let t = 0; t < i.length; t++) {
    const e = i[t];e.parentNode.removeChild(e), s.textContent += e.textContent;
  }if ((t => {
    z.forEach(e => {
      const n = M.get(j(e, t));void 0 !== n && n.keyString.forEach(t => {
    ...
    const { element: { content: i }, parts: s } = t;if (null == n) return void i.appendChild(e);const r = document.createTreeWalker(i, R, null, !1);let a = H(s),
        o = 0,
        l = -1;for (; r.nextNode();) for (l++, r.currentNode === n && (o = V(e), n.parentNode.insertBefore(e, n)); -1 !== a && s[a].index === l;) {
      if (o > 0) {
...
window.JSCompiler_renameProperty = (t, e) => t;const U = { toAttribute(t, e) {
  ...
  constructor() {
  ...
  }static _valueHasChanged(t, e, n = D) {
    return n(t, e);
    ...
    if (this._updateState & X) return;const n = this.constructor,
      ...
      const t = n._classProperties.get(i) || B;this._updateState = this._updateState | Y, this[i] = n._propertyValueFromAttribute(e, t), this._updateState = this._updateState & ~Y;
    }
  }_requestUpdate(t, e) {
    let n = !0;if (void 0 !== t) {
      const i = this.constructor,
            s = i._classProperties.get(t) || B;i._valueHasChanged(this[t], e, s.hasChanged) ? (this._changedProperties.has(t) || this._changedProperties.set(t, e), !0 !== s.reflect || this._updateState & Y || (void 0 === this._reflectingProperties && (this._reflectingProperties = new Map()), this._reflectingProperties.set(t, s))) : n = !1;
    }!this._hasRequestedUpdate && n && this._enqueueUpdate();
  }requestUpdate(t, e) {
    return this._requestUpdate(t, e), this.updateComplete;
  }async _enqueueUpdate() {
    let t, e;this._updateState = this._updateState | J;const n = this._updatePromise;this._updatePromise = new Promise((n, i) => {
      t = n, e = i;
    });try {
      await n;
...
const Z = (t, e) => "method" !== e.kind || !e.descriptor || "value" in e.descriptor ? { kind: "field", key: Symbol(), placement: "own", descriptor: {}, initializer() {
  ...
  return (e, n) => void 0 !== n ? tt(t, e, n) : Z(t, e);
}
/**
@license
...
(window.litElementVersions || (window.litElementVersions = [])).push("2.0.1");const rt = t => t.flat ? t.flat(1 / 0) : function t(e, n = []) {
  ...
  const i = n.scopeName,
    ...
    let i = T.get(e);void 0 === i && (r(e, e.firstChild), T.set(e, i = new w(Object.assign({ templateFactory: E }, n))), i.appendInto(e)), i.setValue(t), i.commit();
  })(t, l, Object.assign({ templateFactory: F(i) }, n)), o) {
    const t = T.get(l);T.delete(l), t.value instanceof g && q(l, t.value.template, i), r(e, e.firstChild), e.appendChild(l), T.set(e, t);
...
const ot = new WeakMap(),
  ...
  t = gt(t, 255), e = gt(e, 255), n = gt(n, 255);var i = Math.max(t, e, n),
      s = Math.min(t, e, n),
      r = 0,
      a = 0,
  ...
  var s = [vt(Math.round(t).toString(16)), vt(Math.round(e).toString(16)), vt(Math.round(n).toString(16))];return i && s[0].charAt(0) === s[0].charAt(1) && s[1].charAt(0) === s[1].charAt(1) && s[2].charAt(0) === s[2].charAt(1) ? s[0].charAt(0) + s[1].charAt(0) + s[2].charAt(0) : s.join("");
}function kt(t) {
  return Ct(t) / 255;
}function Ct(t) {
  ...
  var e,
    ...
    if (0 === (t = t.trim().toLowerCase()).length) return !1;var e = !1;if (At[t]) t = At[t], e = !0;else if ("transparent" === t) return { r: 0, g: 0, b: 0, a: 0, format: "name" };var n = Tt.rgb.exec(t);if (n) return { r: n[1], g: n[2], b: n[3] };if (n = Tt.rgba.exec(t)) return { r: n[1], g: n[2], b: n[3], a: n[4] };if (n = Tt.hsl.exec(t)) return { h: n[1], s: n[2], l: n[3] };if (n = Tt.hsla.exec(t)) return { h: n[1], s: n[2], l: n[3], a: n[4] };if (n = Tt.hsv.exec(t)) return { h: n[1], s: n[2], v: n[3] };if (n = Tt.hsva.exec(t)) return { h: n[1], s: n[2], v: n[3], a: n[4] };if (n = Tt.hex8.exec(t)) return { r: Ct(n[1]), g: Ct(n[2]), b: Ct(n[3]), a: kt(n[4]), format: e ? "name" : "hex8" };if (n = Tt.hex6.exec(t)) return { r: Ct(n[1]), g: Ct(n[2]), b: Ct(n[3]), format: e ? "name" : "hex" };if (n = Tt.hex4.exec(t)) return { r: Ct(n[1] + n[1]), g: Ct(n[2] + n[2]), b: Ct(n[3] + n[3]), a: kt(n[4] + n[4]), format: e ? "name" : "hex8" };if (n = Tt.hex3.exec(t)) return { r: Ct(n[1] + n[1]), g: Ct(n[2] + n[2]), b: Ct(n[3] + n[3]), format: e ? "name" : "hex" };return !1;
  }(t)), "object" == typeof t && ($t(t.r) && $t(t.g) && $t(t.b) ? (e = t.r, n = t.g, i = t.b, s = { r: 255 * gt(e, 255), g: 255 * gt(n, 255), b: 255 * gt(i, 255) }, c = !0, h = "%" === String(t.r).substr(-1) ? "prgb" : "rgb") : $t(t.h) && $t(t.s) && $t(t.v) ? (a = _t(t.s), o = _t(t.v), s = function (t, e, n) {
    t = 6 * gt(t, 360), e = gt(e, 100), n = gt(n, 100);var i = Math.floor(t),
        s = t - i,
        r = n * (1 - e),
        a = n * (1 - s * e),
        o = n * (1 - (1 - s) * e),
        l = i % 6;return { r: 255 * [n, a, r, r, o, n][l], g: 255 * [o, n, n, a, r, r][l], b: 255 * [r, r, o, n, n, a][l] };
  }(t.h, a, o), c = !0, h = "hsv") : $t(t.h) && $t(t.s) && $t(t.l) && (a = _t(t.s), l = _t(t.l), s = function (t, e, n) {
    var i, s, r;function a(t, e, n) {
      return n < 0 && (n += 1), n > 1 && (n -= 1), n < 1 / 6 ? t + 6 * n * (e - t) : n < .5 ? e : n < 2 / 3 ? t + (e - t) * (2 / 3 - n) * 6 : t;
    }if (t = gt(t, 360), e = gt(e, 100), n = gt(n, 100), 0 === e) s = n, r = n, i = n;else {
    ...
    Et = "[\\s|\\(]+(" + Nt + ")[,|\\s]+(" + Nt + ")[,|\\s]+(" + Nt + ")\\s*\\)?",
    Mt = "[\\s|\\(]+(" + Nt + ")[,|\\s]+(" + Nt + ")[,|\\s]+(" + Nt + ")[,|\\s]+(" + Nt + ")\\s*\\)?",
    Tt = { CSS_UNIT: new RegExp(Nt), rgb: new RegExp("rgb" + Et), rgba: new RegExp("rgba" + Mt), hsl: new RegExp("hsl" + Et), hsla: new RegExp("hsla" + Mt), hsv: new RegExp("hsv" + Et), hsva: new RegExp("hsva" + Mt), hex3: /^#?([0-9a-fA-F]{1})([0-9a-fA-F]{1})([0-9a-fA-F]{1})$/, hex6: /^#?([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})$/, hex4: /^#?([0-9a-fA-F]{1})([0-9a-fA-F]{1})([0-9a-fA-F]{1})([0-9a-fA-F]{1})$/, hex8: /^#?([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})$/ };function $t(t) {
  return Boolean(Tt.CSS_UNIT.exec(String(t)));
}var Rt = function () {
  function t(e, n) {
    if (void 0 === e && (e = ""), void 0 === n && (n = {}), e instanceof t) return e;this.originalInput = e;var i = Pt(e);this.originalInput = e, this.r = i.r, this.g = i.g, this.b = i.b, this.a = i.a, this.roundA = Math.round(100 * this.a) / 100, this.format = n.format || i.format, this.gradientType = n.gradientType, this.r < 1 && (this.r = Math.round(this.r)), this.g < 1 && (this.g = Math.round(this.g)), this.b < 1 && (this.b = Math.round(this.b)), this.isValid = i.ok;
    ...
    return void 0 === t && (t = !1), function (t, e, n, i, s) {
      var r,
          a = [vt(Math.round(t).toString(16)), vt(Math.round(e).toString(16)), vt(Math.round(n).toString(16)), vt((r = i, Math.round(255 * parseFloat(r)).toString(16)))];return s && a[0].charAt(0) === a[0].charAt(1) && a[1].charAt(0) === a[1].charAt(1) && a[2].charAt(0) === a[2].charAt(1) && a[3].charAt(0) === a[3].charAt(1) ? a[0].charAt(0) + a[1].charAt(0) + a[2].charAt(0) + a[3].charAt(0) : a.join("");
    ...
    if (0 === this.a) return "transparent";if (this.a < 1) return !1;for (var t = "#" + xt(this.r, this.g, this.b, !1), e = 0, n = Object.keys(At); e < n.length; e++) {
      var i = n[e];if (At[i] === t) return i;
    }return !1;
  ...
  const n = new Rt(Ht(t));if (n.isValid) {
    const t = n.mix("black", 100 - e).toString();if (t) return t;
  }return t;
}function Lt(...t) {
  const e = t => t && "object" == typeof t;return t.reduce((t, n) => (Object.keys(n).forEach(i => {
    const s = t[i],
          r = n[i];Array.isArray(s) && Array.isArray(r) ? t[i] = s.concat(...r) : e(s) && e(r) ? t[i] = Lt(s, r) : t[i] = r;
  }), t), {});
}const Ft = (t, e, n, i) => {
  i = i || {}, n = null == n ? {} : n;const s = new Event(e, { bubbles: void 0 === i.bubbles || i.bubbles, cancelable: Boolean(i.cancelable), composed: void 0 === i.composed || i.composed });return s.detail = n, t.dispatchEvent(s), s;
},
      zt = (t, e) => {
  return ((t, e, n = !0) => {
    const i = Vt(e),
          s = "group" === i ? "homeassistant" : i;let r;switch (i) {case "lock":
        r = n ? "unlock" : "lock";break;case "cover":
        r = n ? "open_cover" : "close_cover";break;default:
        r = n ? "turn_on" : "turn_off";}return t.callService(s, r, { entity_id: e });
  ...
  Ft(t, "haptic", e);
      ...
      qt = (t, e, n, i, s) => {
  let r;switch (s && n.dbltap_action ? r = n.dbltap_action : i && n.hold_action ? r = n.hold_action : !i && n.tap_action && (r = n.tap_action), r || (r = { action: "toggle" }), r.action) {case "more-info":
      (n.entity || n.camera_image) && (Ft(t, "hass-more-info", { entityId: n.entity ? n.entity : n.camera_image }), r.haptic && It(t, r.haptic));break;case "navigate":
      r.navigation_path && (((t, e, n = !1) => {
        n ? history.replaceState(null, "", e) : history.pushState(null, "", e), Ft(window, "location-changed", { replace: n });
      ...
      n.entity && (zt(e, n.entity), r.haptic && It(t, r.haptic));break;case "call-service":
      {
        if (!r.service) return;const [i, s] = r.service.split(".", 2),
              a = Object.assign({}, r);r.service_data && "entity" === r.service_data.entity_id && (a.service_data.entity_id = n.entity), e.callService(i, s, a.service_data), r.haptic && It(t, r.haptic);
      }}
},
...
`;let Gt = class extends at {
  static get styles() {
    ...
    let n = this.config.default_color;return t && (t.attributes.rgb_color ? (n = `rgb(${t.attributes.rgb_color.join(",")})`, t.attributes.brightness && (n = jt(n, (t.attributes.brightness + 245) / 5))) : e && t.attributes.color_temp && t.attributes.min_mireds && t.attributes.max_mireds ? (n = function (t, e, n) {
      const i = new Rt("rgb(255, 160, 0)"),
            s = new Rt("rgb(166, 209, 255)"),
            r = new Rt("white"),
            a = (t - e) / (n - e) * 100;return a < 50 ? Ot(s).mix(r, 2 * a).toRgbString() : Ot(r).mix(i, 2 * (a - 50)).toRgbString();
    }(t.attributes.color_temp, t.attributes.min_mireds, t.attributes.max_mireds), t.attributes.brightness && (n = jt(n, (t.attributes.brightness + 245) / 5))) : n = t.attributes.brightness ? jt(this._getDefaultColorForState(t), (t.attributes.brightness + 245) / 5) : this._getDefaultColorForState(t)), n;
    ...
    const t = this.config.entity ? this.hass.states[this.config.entity] : void 0,
        ...
        return this._blankCardColoredHtml(o);case "card":case "label-card":
        {
          ...
          }(n);s.color = t, r.color = t, s["background-color"] = n, s = Object.assign({}, s, o), i = "inherit";break;
        }default:
    ...
    const i = this._buildIcon(t, e),
          ...
          c = Object.assign({}, l, r);return i || s ? $`
        <div id="img-cell" style=${ct(o)}>
          ${i && !s ? $`<ha-icon style=${ct(l)}
